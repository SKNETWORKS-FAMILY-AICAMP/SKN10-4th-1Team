...
| 담당 영역 | 주요 업무 | 세부 작업 |
|---------|---------|----------|
| **RAG 파이프라인 개발** | 검색 파이프라인 구축 | - LangGraph 워크플로우 구현<br>- 질의 분석 로직 개발<br>- 검색 전략 최적화 |
| **Neo4j 데이터베이스** | 그래프 DB 구축 | - 스키마 설계<br>- 데이터 적재<br>- 벡터 검색 구현<br>- 그래프 쿼리 최적화 |
